  ...
  return (
    <>
      ...
      <div className="lg:hidden bg-white shadow-sm border-b border-gray-200 px-3 sm:px-4 py-3">
        ...
        <div className="mt-3 flex items-center space-x-2 p-2 bg-blue-50 rounded-lg">
          <span className="text-2xl">{activeCalc?.icon}</span>
          <div>
            <div className="text-sm font-medium text-blue-900">{activeCalc?.name}</div>
            <div className="text-xs text-blue-700">{activeCalc?.description}</div>
          </div>
        </div>
      </div>
              ...
              >
                ...
                <div className="flex-1 text-left">
                  ...
                  <div className={`text-sm ${
                    activeCalculator === calculator.id ? 'text-blue-100' : 'text-gray-500'
                  }`}>
